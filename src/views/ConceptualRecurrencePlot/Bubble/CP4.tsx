  ...
  return (
    <>
      ...
      >
        ...
        <g className="CP4">
          <g className="T4">
            <title>Keyword: AVMS, a solution to the jobs problem?</title>
            <text transform="matrix(1 0 0 1 806.4214 56.5149)">
              <tspan x={0} y={0} className="st0 st1 st2">
                {"AVMS, a solution "}
              </tspan>
              <tspan x={-9.7} y={17} className="st0 st1 st2">
                {"to the jobs problem?"}
              </tspan>
            </text>
          </g>
          <g className="T4-1">
            ...
            <title>Keyword: Can it provide jobs?</title>
            <text transform="matrix(1 0 0 1 812.2222 118.3016)" className="st7">
              <tspan x={0} y={0} className="st0 st1 st8">
                {"Can it "}
              </tspan>
              <tspan x={-13} y={9} className="st0 st1 st8">
                {"provide jobs? "}
              </tspan>
            </text>
          </g>
          <g className="T4-1-J1">
            ...
            <title>Keyword: Conscription career breaks</title>
            <text transform="matrix(1 0 0 1 794.6953 150.9248)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st36">
                {"Conscription "}
              </tspan>
              <tspan x={0} y={4.1} className="st24 st1 st36">
                {"career breaks"}
              </tspan>
            </text>
          </g>
          <g className="T4-1-L1">
            ...
            <text transform="matrix(1 0 0 1 828.2578 152.1304)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st60">
                {"Economic "}
              </tspan>
              <tspan x={4.3} y={5.7} className="st24 st1 st60">
                {"Boom "}
              </tspan>
              <tspan x={-2.7} y={11.4} className="st24 st1 st60">
                {"Recruitment "}
              </tspan>
              <tspan x={2.8} y={17.1} className="st24 st1 st60">
                {"Difficult"}
              </tspan>
            </text>
          </g>
          <g className="T4-1-L2">
            ...
            <text
              ...
              className="st7"
            >
              <tspan x={0} y={0} className="st24 st1 st63">
                {"A certain "}
              </tspan>
              <tspan x={-1.6} y={5.2} className="st24 st1 st63">
                {"amount of "}
              </tspan>
              <tspan x={5.5} y={10.4} className="st24 st1 st63">
                {"jobs"}
              </tspan>
            </text>
          </g>
          <g className="T4-1-J2">
            ...
            <text
              ...
              className="st7"
            >
              <tspan x={0} y={0} className="st24 st1 st65">
                {"Provide"}
              </tspan>
              <tspan x={-9.1} y={8.1} className="st24 st1 st65">
                {"210,000 jobs"}
              </tspan>
            </text>
          </g>
          <g className="T4-2">
            ...
            <title>Keyword: What is the current soldier's status?</title>
            <text transform="matrix(1 0 0 1 864.0957 122.8211)" className="st7">
              <tspan x={0} y={0} className="st0 st1 st8">
                {"What is the current "}
              </tspan>
              <tspan x={7} y={9} className="st0 st1 st8">
                {"soldier's status?"}
              </tspan>
            </text>
          </g>
          <g className="T4-2-K1">
            ...
            <title>Keyword: Reducing bad habits</title>
            <text transform="matrix(1 0 0 1 880.7319 156.6108)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st37">
                {"Reducing "}
              </tspan>
              <tspan x={-0.5} y={4.8} className="st24 st1 st37">
                {"bad habits"}
              </tspan>
            </text>
          </g>
          <g className="T4-2-P1">
            ...
            <title>Keyword: Limited social status</title>
            <text transform="matrix(1 0 0 1 912.1846 156.5615)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st39">
                {"Limited "}
              </tspan>
              <tspan x={2.9} y={8.3} className="st24 st1 st39">
                {"social "}
              </tspan>
              <tspan x={3.3} y={16.5} className="st24 st1 st39">
                {"status"}
              </tspan>
            </text>
          </g>
          <g className="T4-2-L1">
            ...
            <text transform="matrix(1 0 0 1 895.0972 200.0684)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st88">
                {"Difficulty in "}
              </tspan>
              <tspan x={2.4} y={5.3} className="st24 st1 st88">
                {"retaining "}
              </tspan>
              <tspan x={4.5} y={10.6} className="st24 st1 st88">
                {"soldiers"}
              </tspan>
            </text>
          </g>
          <g className="T4-2-P2">
            ...
            <title>Keyword: Need to improve military social awareness</title>
            <text transform="matrix(1 0 0 1 926.7686 189.4512)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st35">
                {"Need to "}
              </tspan>
              <tspan x={-0.1} y={3.8} className="st24 st1 st35">
                {"improve "}
              </tspan>
              <tspan x={-4} y={7.7} className="st24 st1 st35">
                {"military social "}
              </tspan>
              <tspan x={-1.4} y={11.5} className="st24 st1 st35">
                {"awareness"}
              </tspan>
            </text>
          </g>
          <g className="T4-2-K2">
            ...
            <title>Keyword: Self-development benefits</title>
            <text transform="matrix(1 0 0 1 871.2529 184.6523)" className="st7">
              <tspan x={0} y={0} className="st24 st1 st38">
                {"Self-development "}
              </tspan>
              <tspan x={7.2} y={3.7} className="st24 st1 st38">
                {"benefits"}
              </tspan>
            </text>
          </g>
