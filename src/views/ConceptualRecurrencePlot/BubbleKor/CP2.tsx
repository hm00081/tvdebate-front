          ...
          <g className="T2">
            <g className="P2">
              ...
              <g>
                ...
                />
                <title>
                  {`scriptIndex: 23\nName: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[23]?.name}\nUtterance: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[23]?.utterance}`}
                </title>
              </g>
              <g>
                <path
                ...
                />
                <title>
                  {`scriptIndex: 22\nName: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[22]?.name}\nUtterance: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[22]?.utterance}`}
                </title>
              </g>
              <g>
                <path
                ...
                />
                <title>
                  {`scriptIndex: 21\nName: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[21]?.name}\nUtterance: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[21]?.utterance}`}
                </title>
              </g>
              <g>
                <path
                ...
                />
                <title>
                  {`scriptIndex: 20\nName: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[20]?.name}\nUtterance: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[20]?.utterance}`}
                </title>
              </g>
              <g>
                <path
                ...
                />
                <title>
                  {`scriptIndex: 19\nName: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[19]?.name}\nUtterance: ${dataStructureSet?.utteranceObjectsForDrawingManager?.utteranceObjectsForDrawing[19]?.utterance}`}
                </title>
              </g>
              <g>
                <path
